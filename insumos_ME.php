...
<html lang="en">
<head>
  <title>Material Electrico</title>
  <meta charset="utf-8">
...
<div class="row">
 <nav class="col-md-2 d-none d-md-block  sidebar">
   ...
   <div class="panel panel-default">
     ...
     <div id="collapse1" class="panel-collapse collapse">
       <ul class="list-group">
         <li class=""><a class="nav-link active" href="insumos_ME.php">Material Eléctrico</a></li>
 ...
 <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
   <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
     <h1 class="h2">Material Electrico</h1>
         ...
         <div class="modal-dialog modal-lg">
           ...
           <div class="modal-content">
             ...
             <div class="col-md-6 form-group">
               <label for="codigo">Provedor</label>
               <input type="text" class="form-control" id="provedor">
             </div>
             <div class="col-md-6 form-group">
               <label for="codigo_medida">Unidad de Medida</label>
               <input type="text" class="form-control" id="unidad_medida">
             </div>
             <div class="col-md-6 form-group">
               <label for="codigo">Estante</label>
               <input type="text" class="form-control cantidades" id='estante'>
             </div>
             <div class="col-md-6 form-group">
               <label for="codigo">Ubicacion</label>
               <input type="text" class="form-control cantidades" id='ubicacion'>
             </div>
             <div class="col-md-12 form-group">
               <label for="codigo">Comentario</label>
               <textarea class="form-control" style="background: #D9D9D9"rows="5" id="comentario"></textarea>
             </div>


             </div>
             <div class="modal-footer">
               <button type='button' class='btn btn-default' onclick='registra_insumos();' id='btn-reg-insumos'><i class="fas fa-save color"></i></button>
             </div>
...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
   <script>window.jQuery || document.write('<script src="/docs/4.2/assets/js/vendor/jquery-slim.min.js"><\/script>')</script><script src="/docs/4.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-zDnhMsjVZfS3hiP7oCBRmfjkQC4fzxVxFhBx8Hkz2aZX8gEvA/jsP3eXRCvzTofP" crossorigin="anonymous"></script>
     ...
     <script src="dist/js/source_insumos.js"></script>

...
<body onload="pone_equipos_modelo();">
...
<div class="row">
 ...
 <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
   ...
   <div class='col-md-12'>
   <div id='modelos_registrados'></div>
   </div>
     ...
     <!-- Modal -->
       <div class="modal fade" id="myModal" role="dialog">
         <div class="modal-dialog modal-lg">
           ...
           <!-- Modal content-->
           <form  class="wpcf7-form" method="POST" action="alta_modelos.php">
           <div class="modal-content">
             <div class="modal-header">
               <button type="button" class="close" data-dismiss="modal">&times;</button>
             </div>
             <input type="text" hidden="" id="idequipo" name="">
           ...
           <br>
             ...
             <div class="col-md-12 form-group">
               <label for="codigo">No. de Serie</label>
               <input type="text" class="form-control" id="condensadora_serie" name="condensadora_serie">
             </div>
             <div class=" col-md-12">
           <h4>Evaporadora</h4>
         </div>
         <br>
             ...
             <div class="col-md-12 form-group">
               <label for="codigo_medida">No. de Serie</label>
               <input type="text" class="form-control" id="evaporadora_serie" name="evaporadora_serie">
             </div>
             <div class="modal-header col-md-12"></div>
             <br><br>
             <div class="col-md-6 form-group">
               <label for="codigo">Estante</label>
               <input type="text" class="form-control cantidades" id='estante' name="estante">
             </div>
             <div class="col-md-6 form-group">
...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
   <script>window.jQuery || document.write('<script src="/docs/4.2/assets/js/vendor/jquery-slim.min.js"><\/script>')</script><script src="/docs/4.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-zDnhMsjVZfS3hiP7oCBRmfjkQC4fzxVxFhBx8Hkz2aZX8gEvA/jsP3eXRCvzTofP" crossorigin="anonymous"></script>
     ...
     <script src="plugins/datatables/jquery.dataTables.min.js"></script>
     <script src="plugins/datatables/dataTables.bootstrap.min.js"></script>
     <script src="dist/js/source_equipos_modelo.js"></script>
     <script>
     ...
     <script>
     function cambiar(){
         location.href="equipo_modelo.php"
     }
     </script>
